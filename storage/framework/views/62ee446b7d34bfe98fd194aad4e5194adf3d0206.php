...
<?php $__env->startSection('title','Controle de produto - Dashboard / formulário: Localização'); ?>
...
<div class="container" id="topPage">
            <h1 class="h2">Cadastro / <a href="<?php echo e(route('dashboard.cadastro.localizacao')); ?>">Localização</a> / Formulário: Localização</h1> 
...
<?php echo $__env->make('dashboard.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\Projects\Controle de Produto\controle_produto\resources\views/dashboard/cadastro/localizacao/localizacaoForm.blade.php ENDPATH**/ ?>