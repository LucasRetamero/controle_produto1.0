...
<table id="mydata">
 ...
 <tbody>
  <tr>
	<td>Existentes</td>  
	<td><?php echo e($allEndereco); ?></td>  
   </tr>
   
   <tr>
	<td>Ocupados</td>  
	<td><?php echo e($usedEndereco); ?></td>  
  </tr>
  
  <tr>
	<td>Vazio</td>  
	<td><?php echo e($emptyEndereco); ?></td>  
  </tr>
...
<?php /**PATH J:\Projects\Controle de Produto\controle_produto\resources\views/dashboard/home.blade.php ENDPATH**/ ?>