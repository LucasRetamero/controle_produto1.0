...
<div id="containerQuery" class="hiddenDiv">
  <div class="row">  
     ...
     <form method="post" action="<?php echo e(route('dashboard.cadastro.lote.searching')); ?>">
      <div class="form-row">
...
<table class="table">
  ...
  <tbody>
    <?php if($dadosLote->count() > 0): ?>
  <?php $__currentLoopData = $dadosLote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      ...
      <td>
	    <div class="row"> <!-- buttons edit /  remove--> 
         <div class="col-sm-12 text-center">
          <a href="<?php echo e(route('dashboard.cadastro.lote.loteAddForm.editOrRemove', ['id' => $item->id, 'option' => 'edit' ] )); ?>"><button id="btnUpdate" class="btn btn-warning btn-md center-block"><img src="<?php echo e(asset('img/icons/editIcon.png')); ?>" class="imgIcons"/> Editar</button></a>
          <a href="<?php echo e(route('dashboard.cadastro.lote.loteAddForm.editOrRemove', ['id' => $item->id, 'option' => 'remove'] )); ?>" onclick="return confirm('Deseja realmente remover esse item ?')"><button id="btnRemove" class="btn btn-danger btn-md center-block"><img src="<?php echo e(asset('img/icons/removeIcon.png')); ?>" class="imgIcons"/> Remover</button></a>
         </div>
