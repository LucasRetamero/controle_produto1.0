...
class ProdutoFornecedorExport implements FromCollection,WithHeadings,ShouldAutoSize,WithEvents
{
   ...
   use RegistersEventListeners;
	...
	public function collection(){
	 return ProdutosDAO::where('fornecedor', 'like', $this->fornecedor.'%')->get();	
	}
