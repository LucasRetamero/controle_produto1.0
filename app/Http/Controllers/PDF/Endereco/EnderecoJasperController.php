...
namespace App\Http\Controllers\PDF\Endereco;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use PHPJasper\PHPJasper;

class EnderecoJasperController extends Controller
{    
   ...
   public function generateReport(){   
	...
	switch($this->getOption()){
	  case "endereco":
		$fileToConvertInJasper = '/report/Endereco/EnderecoEnderecoReport.jrxml';
        $fileConvertedinJasper = '/report/Endereco/EnderecoEnderecoReport.jasper';	
		$options = [
         'format' => ['pdf'],
         'locale' => 'en',
      ...
      case "noFilter":  
       $fileToConvertInJasper = '/report/Endereco/EnderecoTodosReport.jrxml';
       $fileConvertedinJasper = '/report/Endereco/EnderecoTodosReport.jasper';	
	   $options = [
         'format' => ['pdf'],
         'locale' => 'en',
         'params' => [],
