...
<div class="jumbotron bg-primary">
   ...
   <form class="form-signin" method="post" action="{{ route('dashboard.cadastro.produto.productAddForm.action') }}">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        ...
        @if(isset($dadosProduto))
		 ...
		 <input  type="text" class="form-control" id="id_codigo" name="id" placeholder="Codigo do produto....." value="{{ $dadosProduto[0]->id }}" />		
		@endif 
        ...
        @if(isset($dadosProduto))
		 <input  type="text" class="form-control" id="txt_ean" name="ean" placeholder="Digite EAN(Codigo de barras)....." value="{{ $dadosProduto[0]->ean }}" />   
	   @else
		...
		<div class="form-group">
         ...
         @if(isset($dadosProduto))
	      <input type="text" class="form-control" id="txt_nome"  name="nome" placeholder="Digite o nome....." value="{{ $dadosProduto[0]->nome }}">
		@else
		...
		<div class="form-group">
         ...
         @if(isset($dadosProduto))
	      <input type="date" class="form-control" id="dt_validade" name="data_vencimento" value="{{ $dadosProduto[0]->data_vencimento }}">
		@else
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
        ...
        <div class="form-group">
         ...
         @if(isset($dadosProduto))
	      <input type="text" class="form-control" id="txt_atualQtd"  name="quant_atual"value="{{ $dadosProduto[0]->quant_atual }}" placeholder="Digite a quantidade atual no estoque....">
  		@else
		 <input type="text" class="form-control" id="txt_atualQtd"  name="quant_atual" placeholder="Digite a quantidade atual no estoque....">
    	  ...
    	  <div class="col">
	       <label for="txt_minQtd" class="h5">Quantidade minima</label>
            @if(isset($dadosProduto))
	        <input type="text" class="form-control" id="txt_atualQtd"  name="quant_minimo" value="{{ $dadosProduto[0]->quant_minimo }}" placeholder="Digite a quantidade minima no estoque....">
		 @else
      ...
      <div class="card-body">
		 ...
		 <div class="form-group">
		  ...
		  <div id="attLocalizacao" class="col">
           ...
           @if(isset($dadosProduto))
	         @if($dadosProduto[0]->localizacao == 'item')  
		...
		<option value="teste" selected>Selecione a localização</option>  			  
		  ...
		  <div class="col">
           ...
           @if(isset($dadosProduto))
	         @if($dadosProduto[0]->sub_especie == 'item')  
...
<table class="table">
 ...
 <button type="submit" name="btnAction" class="btn btn-success btn-block" style="font-size:x-large;" value="btnAdd"><img src="{{ asset('img\icons\addIcon.png') }}"></img>Cadastrar</button>
 </br><button type="submit" name="btnAction" class="btn btn-light btn-block" style="font-size:x-large;" value="btnRefresh"><img src="{{ asset('img\icons\reloadIcon.png') }}" width="40px" height="40px"></img>Atualizar</button>
 </br><button type="submit" name="btnAction" class="btn btn-warning btn-block" style="font-size:x-large;" value="btnEdit"><img src="{{ asset('img\icons\editIcon.png') }}" width="40px" height="40px"></img>Editar</button>
 </br><button type="submit" name="btnAction" class="btn btn-danger btn-block" style="font-size:x-large;" value="btnRemove"><img src="{{ asset('img\icons\removeIcon.png') }}" width="40px" height="40px"></img>Remover</button>
 </br><a href="{{ route('dashboard.cadastro.produto') }}"><button type="submit" name="btnAction" class="btn btn-light btn-block" style="font-size:x-large;" value="btnCancel"><img src="{{ asset('img\icons\NoIcon.png') }}" width="40px" height="40px"></img>Cancelar</button></a>
  <!-- Actions buttons 
  <center><div class="btn-group" role="group" aria-label="Basic example">
