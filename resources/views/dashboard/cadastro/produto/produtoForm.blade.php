...
@section('content')
    ...
    <div class="container" id="topPage">
        <h1 class="h2">Cadastro / <a href="{{ route('dashboard.cadastro.produto') }}">Produto</a> / Formulário: Produto
        </h1>
    ...
    <div class="jumbotron bg-primary">
        ...
        <form class="form-signin needs-validation" method="post"
            action="{{ route('dashboard.cadastro.produto.productAddForm.action') }}" novalidate>
            ...
            @if (!empty(Auth::User()->empresa_id))
                @if (isset($dadosProduto))
                    ...
                    <input type="hidden" id="empresa_id" name="empresa_id" value="{{ $dadosProduto[0]->empresa_id }}">
                @endif
            @endif
                ...
                <div class="col-sm-9">
                    @if (isset($dadosProduto))
                        <input type="text" class="form-control" id="txtCodigo" name="codigo"
                            value="{{ $dadosProduto[0]->codigo }}" placeholder="Digite o Codigo do produto..." required
                            autofocus>
                    @else
                        <input type="text" class="form-control" id="txtCodigo" name="codigo"
                            placeholder="Digite o Codigo do produto..." required autofocus>
                    @endif
                ...
                <div class="col-sm-9">
                    @if (isset($dadosProduto))
                        <input type="text" class="form-control" id="txtNome" name="nome"
                            value="{{ $dadosProduto[0]->nome }}" placeholder="Digite o nome do produto..." required
                            autofocus>
                    @else
                        <input type="text" class="form-control" id="txtNome" name="nome"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    @if (isset($dadosProduto))
                        <input type="text" class="form-control" id="txtEAN" name="ean"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    @if (isset($dadosProduto))
                        <input type="text" class="form-control" id="txtFornecedor" name="fornecedor"
                            value="{{ $dadosProduto[0]->fornecedor }}" placeholder="Digite o fornecedor do produto..."
                            required autofocus>
                    @else
                        <input type="text" class="form-control" id="txtFornecedor" name="fornecedor"
                ...
                <div class="col-sm-9">
                    @if (isset($dadosProduto))
                        <input type="text" class="form-control" id="txtReferencia" name="referencia"
                            ...
                            placeholder="Digite a referencia(codigo do fornecedor)..." required autofocus>
                    @else
                        <input type="text" class="form-control" id="txtReferencia" name="referencia"
                            placeholder="Digite a referencia(codigo do fornecedor)..." required autofocus>
                    @endif
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    @if (isset($dadosProduto))
                        <input type="text" class="form-control" id="txtEtica" name="etica"
                            value="{{ $dadosProduto[0]->fornecedor }}"
                            placeholder="Digite a referencia(codigo do fornecedor)..." required autofocus>
                    @else
                        <input type="text" class="form-control" id="txtEtica" name="etica"
            ...
            @endif
            </br><a href="{{ route('dashboard.cadastro.produto') }}" class="btn btn-light btn-block"
                style="font-size:x-large;"><img src="{{ asset('img\icons\leftArrowIcon.png') }}" width="40px"
                    height="40px"></img>Lista de Produtos</a>
