...
<div class="container" id="topPage">
            <h1 class="h2">Relatório / Endereço / Configuração: Endereço</h1> 
...
@endif
 ...
 <div class="jumbotron bg-primary">
  ...
  <div id="containerQuery" class="hiddenDiv"> 
         <div class="col-sm-12">
     <form method="get" action="{{ route('dashboard.pdf.endereco.actionsMenu') }}" target="_blank">
     ...
     <div class="col2">
      <label  class="col text-white h4">Digite a consulta:</label>	
	   ...
	   <a href="{{ route('dashboard.cadastro.endereco') }}" target="_blank" class="btn btn-light btn-block" style="font-size:x-large;"><img src="{{ asset('img\icons\leftArrowIcon.png') }}" width="40px" height="40px"></img>Lista de Endereços</a>
