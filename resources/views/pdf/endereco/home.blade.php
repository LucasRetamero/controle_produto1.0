        ...
        <div id="containerQuery" class="hiddenDiv">
            <div class="col-sm-12">
                <form method="get" action="{{ route('dashboard.pdf.endereco.actionsMenu') }}" target="_blank">
                        ...
                        <div class="col2">
                            ...
                            <div id="searchInput" class="form-group">
                                <input type="text" id="nameSearch" name="consulta" class="form-control"
                                    placeholder="Digite para pesquisar sobre o endereço...">
                            </div>
                        </div>
                    ...
                    <a href="{{ route('dashboard.cadastro.endereco') }}" target="_blank" class="btn btn-light btn-block"
                        style="font-size:x-large;"><img src="{{ asset('img\icons\leftArrowIcon.png') }}" width="40px"
                            height="40px"></img>Lista de Endereços</a>
