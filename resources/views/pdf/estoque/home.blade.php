...
@section('title','Controle de produto - Dashboard / Relatório: Logistica')
...
@endif
 ...
 <div class="jumbotron bg-primary">
		...
		<div class="container">
          <h1 class="h3 text-white">Relatório: Inventário</h1>
		  <hr style="border-top:3px solid #FFF">
        </div>

  <div id="containerQuery" class="hiddenDiv"> 
         <div class="col-sm-12">
     <form method="get" action="{{ route('dashboard.pdf.estoque.actionsMenu') }}" target="_blank">
	  ...
	  <div class="form">
        ...
        <div class="col2">
		 ...
		 <label  class="col text-white h4">Selecione o tipo do relatório</label>
          <select class="form-control" id="slctQuery" name="cbQuery">
           ...
           <option value="tipoEndereco">Tipo-Endereço</option>
		...
		<!--<input type="hidden" name="cbMode"  value="excel" />-->      
	
     <div class="col2">
      <label  class="col text-white h4">Digite a consulta:</label>	
       <div id="searchInput" class="form-group">
         <input type="text" id="nameSearch" name="consulta" class="form-control" placeholder="Digite para pesquisar sobre o inventario...">
        </div>    
	 </div>
	   ...
	   <a href="{{ route('dashboard.cadastro.estoque') }}" target="_blank" class="btn btn-light btn-block" style="font-size:x-large;"><img src="{{ asset('img\icons\leftArrowIcon.png') }}" width="40px" height="40px"></img>Lista do Inventário</a>
