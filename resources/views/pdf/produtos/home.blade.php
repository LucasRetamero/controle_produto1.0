...
@section('content')
    ...
    <div class="container" id="topPage">
        <h1 class="h2">Relatório / Produto / Formulário: Produto</h1>
    ...
    <div class="jumbotron bg-primary">
        ...
        <div id="containerQuery" class="hiddenDiv">
            <div class="col-sm-12">
                    <form method="post" action="{{ route('dashboard.pdf.produtos.actionsMenu') }}" target="_blank">
                        ...
                        <button type="submit" name="btnAction" value="nameQuery" class="btn btn-success btn-block"
                            style="font-size:x-large;"><img src="{{ asset('img/icons/FilterIcon.png') }}"
                                class="imgIcons" /> Gerar Relatório</button>
                        <a href="{{ route('dashboard.cadastro.produto') }}" target="_blank" class="btn btn-light btn-block"
