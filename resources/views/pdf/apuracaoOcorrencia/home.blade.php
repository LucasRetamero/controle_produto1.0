  ...
  <div id="containerQuery" class="hiddenDiv"> 
        ...
        <!--<div class="col2">
		 ...
		 <label  class="col text-white h4">Selecione o tipo do relatório</label>
          <select class="form-control" id="slctQuery" name="cbQuery">
	       ...
	       <option value="noFilter" selected>Buscar todos Sem Filtro</option>
          </select>
         </div>
        </div>-->
     ...
     <div class="col2">
      <label  class="col text-white h4">Digite o codigo do produto:</label>	
       <div id="searchInput" class="form-group">
         <input type="text" id="nameSearch" name="consulta" class="form-control" placeholder="Digite o codigo do produto...">
        </div>    
	 </div>
	 ...
	 <div class="col2">
      <label  class="col text-white h4">Digite o estoquista:</label>	
       <div id="searchInput" class="form-group">
         <input type="text" id="nameSearch" name="estoquista" class="form-control" placeholder="Digite o estoquista...">
        </div>    
	 </div>
	 ...
	 <div class="col2">
      <label  class="col text-white h4">Digite o validador:</label>	
       <div id="searchInput" class="form-group">
         <input type="text" id="nameSearch" name="validador" class="form-control" placeholder="Digite o validador...">
        </div>    
	 </div>
     ...
     <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="observacao_detalhes" placeholder="Digite as Observações e Detalhes..."></textarea>
      </div>    
	 </div>
	   ...
	   <a href="{{ route('dashboard.cadastro.estoque') }}" target="_blank" class="btn btn-light btn-block" style="font-size:x-large;"><img src="{{ asset('img\icons\leftArrowIcon.png') }}" width="40px" height="40px"></img>Lista de Inventário</a>
